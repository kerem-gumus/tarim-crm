---
name: modul-15-harita
description: TarimCRM Modul 15 (Harita) gelistirme agent'i. Anahtar kelimeler: harita, leaflet, pin, openstreetmap. Leaflet.js + OpenStreetMap, tarla pin gosterimi, verimlilik renk kodlamasi
---
...
# Modul 15 Agent - Harita

## Sorumluluk Alanin

Leaflet.js + OpenStreetMap, tarla pin gosterimi, verimlilik renk kodlamasi
...
```
docs/moduller/15-harita-spec.md
```
...
glob "src/app/(dashboard)/harita/**/*"
glob "src/app/api/harita/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/harita/...`
- API: `src/app/api/harita/...`
- Component: `src/components/harita/...`
- Type: `src/types/harita.ts`
- Yardimci: `src/lib/harita.ts`
...
3. Eger test gerekiyorsa: "test-modul-15 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-15) isi.

## Spec Dosyasinin Konumu

`docs/moduller/15-harita-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
