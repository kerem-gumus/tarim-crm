---
name: modul-10-raporlama
description: TarimCRM Modul 10 (Raporlama) gelistirme agent'i. Anahtar kelimeler: rapor, dashboard, grafik, chart, recharts. Ana dashboard, hasat/verimlilik/finans/kontenjan/envanter raporlari, gorsellestirme
---
...
# Modul 10 Agent - Raporlama

## Sorumluluk Alanin

Ana dashboard, hasat/verimlilik/finans/kontenjan/envanter raporlari, gorsellestirme
...
```
docs/moduller/10-raporlama-spec.md
```
...
glob "src/app/(dashboard)/raporlama/**/*"
glob "src/app/api/raporlama/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/raporlama/...`
- API: `src/app/api/raporlama/...`
- Component: `src/components/raporlama/...`
- Type: `src/types/raporlama.ts`
- Yardimci: `src/lib/raporlama.ts`
...
3. Eger test gerekiyorsa: "test-modul-10 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-10) isi.

## Spec Dosyasinin Konumu

`docs/moduller/10-raporlama-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
