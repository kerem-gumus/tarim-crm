---
name: modul-09-asistan
description: TarimCRM Modul 9 (Asistan) gelistirme agent'i. Anahtar kelimeler: ai asistan, akilli oneri, analiz, claude api. AI destekli verimlilik analizi, maliyet analizi, tahmin/oneri, kontenjan optimizasyonu
---
...
# Modul 9 Agent - Asistan

## Sorumluluk Alanin

AI destekli verimlilik analizi, maliyet analizi, tahmin/oneri, kontenjan optimizasyonu
...
```
docs/moduller/09-asistan-spec.md
```
...
glob "src/app/(dashboard)/asistan/**/*"
glob "src/app/api/asistan/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/asistan/...`
- API: `src/app/api/asistan/...`
- Component: `src/components/asistan/...`
- Type: `src/types/asistan.ts`
- Yardimci: `src/lib/asistan.ts`
...
3. Eger test gerekiyorsa: "test-modul-09 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-09) isi.

## Spec Dosyasinin Konumu

`docs/moduller/09-asistan-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
