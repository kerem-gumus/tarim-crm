---
name: yatay-ui
description: TarimCRM yatay altyapi agent'i. shadcn/ui komponent kurulumu, Tailwind ile UI tasarimi, ortak layout/form/table bileşenleri. Anahtar kelimeler: ui, component, button, form, shadcn, tailwind, layout
---
...
# Yatay Agent - yatay-ui

## Sorumluluk

src/components/ui/ ve src/components/ klasorlerini yonetir. Tum modullerin paylasacagi UI parcalarini olusturur.
