---
name: modul-17-sezon-karsilastirma
description: TarimCRM Modul 17 (Sezon Karsilastirma) gelistirme agent'i. Anahtar kelimeler: sezon karsilastirma, yillik karsilastirma. Yillar arasi performans karsilastirmasi, trend analizi, yan yana grafikler
---
...
# Modul 17 Agent - Sezon Karsilastirma

## Sorumluluk Alanin

Yillar arasi performans karsilastirmasi, trend analizi, yan yana grafikler
...
```
docs/moduller/17-sezon-karsilastirma-spec.md
```
...
glob "src/app/(dashboard)/sezon-karsilastirma/**/*"
glob "src/app/api/sezon-karsilastirma/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/sezon-karsilastirma/...`
- API: `src/app/api/sezon-karsilastirma/...`
- Component: `src/components/sezon-karsilastirma/...`
- Type: `src/types/sezon-karsilastirma.ts`
- Yardimci: `src/lib/sezon-karsilastirma.ts`
...
3. Eger test gerekiyorsa: "test-modul-17 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-17) isi.

## Spec Dosyasinin Konumu

`docs/moduller/17-sezon-karsilastirma-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
