---
name: yatay-mobil
description: TarimCRM yatay altyapi agent'i. Capacitor entegrasyonu, native plugin kurulumu, iOS/Android build pipeline, App Store/Play Store yukleme. Anahtar kelimeler: capacitor, ios build, android build, capacitor sync
---
...
# Yatay Agent - yatay-mobil

## Sorumluluk

capacitor.config.ts, ios/, android/ klasorleri. Modul-21 (Mobil) ile sıkı calisir ama build/deploy katmandir.
