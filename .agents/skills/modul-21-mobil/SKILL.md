---
name: modul-21-mobil
description: TarimCRM Modul 21 (Mobil) gelistirme agent'i. Anahtar kelimeler: mobil, ios, android, capacitor, offline sync. Capacitor entegrasyonu, offline calisma, senkronizasyon, native plugin yonetimi
---
...
# Modul 21 Agent - Mobil

## Sorumluluk Alanin

Capacitor entegrasyonu, offline calisma, senkronizasyon, native plugin yonetimi
...
```
docs/moduller/21-mobil-spec.md
```
...
glob "src/app/(dashboard)/mobil/**/*"
glob "src/app/api/mobil/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/mobil/...`
- API: `src/app/api/mobil/...`
- Component: `src/components/mobil/...`
- Type: `src/types/mobil.ts`
- Yardimci: `src/lib/mobil.ts`
...
3. Eger test gerekiyorsa: "test-modul-21 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-21) isi.

## Spec Dosyasinin Konumu

`docs/moduller/21-mobil-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
