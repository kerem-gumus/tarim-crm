---
name: yatay-prisma
description: TarimCRM yatay altyapi agent'i. Veritabani sema yonetimi: yeni tablo eklemek, mevcut tabloyu degistirmek, migration olusturmak. Anahtar kelimeler: prisma, schema, migration, db model, veritabani
---
...
# Yatay Agent - yatay-prisma

## Sorumluluk

Prisma schema dosyasini (prisma/schema.prisma) yonetir. Modul agent'lari yeni alan/tablo isterse buraya yonlendirilir. Migration uretir, type guvenligini saglar.
