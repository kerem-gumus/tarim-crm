---
name: modul-16-fotograf
description: TarimCRM Modul 16 (Fotograf) gelistirme agent'i. Anahtar kelimeler: fotograf, gorsel, supabase storage, upload. Supabase Storage entegrasyonu, fotograf sikistirma, polymorphic iliski (hasat/tarla/ekipman)
---
...
# Modul 16 Agent - Fotograf

## Sorumluluk Alanin

Supabase Storage entegrasyonu, fotograf sikistirma, polymorphic iliski (hasat/tarla/ekipman)
...
```
docs/moduller/16-fotograf-spec.md
```
...
glob "src/app/(dashboard)/fotograf/**/*"
glob "src/app/api/fotograf/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/fotograf/...`
- API: `src/app/api/fotograf/...`
- Component: `src/components/fotograf/...`
- Type: `src/types/fotograf.ts`
- Yardimci: `src/lib/fotograf.ts`
...
3. Eger test gerekiyorsa: "test-modul-16 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-16) isi.

## Spec Dosyasinin Konumu

`docs/moduller/16-fotograf-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
