---
name: modul-12-bildirim
description: TarimCRM Modul 12 (Bildirim) gelistirme agent'i. Anahtar kelimeler: bildirim, uyari, hatirlatma, push. In-app + push bildirim, stok/odeme/bakim hatirlatmalari, kritik uyarilar
---
...
# Modul 12 Agent - Bildirim

## Sorumluluk Alanin

In-app + push bildirim, stok/odeme/bakim hatirlatmalari, kritik uyarilar
...
```
docs/moduller/12-bildirim-spec.md
```
...
glob "src/app/(dashboard)/bildirim/**/*"
glob "src/app/api/bildirim/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/bildirim/...`
- API: `src/app/api/bildirim/...`
- Component: `src/components/bildirim/...`
- Type: `src/types/bildirim.ts`
- Yardimci: `src/lib/bildirim.ts`
...
3. Eger test gerekiyorsa: "test-modul-12 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-12) isi.

## Spec Dosyasinin Konumu

`docs/moduller/12-bildirim-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
