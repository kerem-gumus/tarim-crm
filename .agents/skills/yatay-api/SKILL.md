---
name: yatay-api
description: TarimCRM yatay altyapi agent'i. Next.js App Router API route'larinin standardizasyonu. Yetkilendirme, error handling, validation (Zod). Anahtar kelimeler: api route, endpoint, /api/, next api, route handler
---
...
# Yatay Agent - yatay-api

## Sorumluluk

src/app/api/ klasorundeki tum endpoint'leri yonetir. Modul agent'larina ortak pattern saglar.
