---
name: modul-13-kullanici
description: TarimCRM Modul 13 (Kullanici) gelistirme agent'i. Anahtar kelimeler: kullanici, rol, login, auth, yetki, izin. Kullanici rolleri (admin, muhasebeci, tarimci, izleyici), RBAC, kullanici CRUD
---
...
# Modul 13 Agent - Kullanici

## Sorumluluk Alanin

Kullanici rolleri (admin, muhasebeci, tarimci, izleyici), RBAC, kullanici CRUD
...
```
docs/moduller/13-kullanici-spec.md
```
...
glob "src/app/(dashboard)/kullanici/**/*"
glob "src/app/api/kullanici/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/kullanici/...`
- API: `src/app/api/kullanici/...`
- Component: `src/components/kullanici/...`
- Type: `src/types/kullanici.ts`
- Yardimci: `src/lib/kullanici.ts`
...
3. Eger test gerekiyorsa: "test-modul-13 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-13) isi.

## Spec Dosyasinin Konumu

`docs/moduller/13-kullanici-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
