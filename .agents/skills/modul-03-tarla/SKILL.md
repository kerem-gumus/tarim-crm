---
name: modul-03-tarla
description: TarimCRM Modul 3 (Tarla) gelistirme agent'i. Anahtar kelimeler: tarla, donum, verimlilik, ada, parsel, koordinat. Tarla kayit, GPS koordinatlari, tarla bazli verimlilik hesaplamasi (kg/donum)
---
...
Tarla kayit, GPS koordinatlari, tarla bazli verimlilik hesaplamasi (kg/donum)
...
```
docs/moduller/03-tarla-spec.md
```
...
glob "src/app/(dashboard)/tarla/**/*"
glob "src/app/api/tarla/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/tarla/...`
- API: `src/app/api/tarla/...`
- Component: `src/components/tarla/...`
- Type: `src/types/tarla.ts`
- Yardimci: `src/lib/tarla.ts`
...
3. Eger test gerekiyorsa: "test-modul-03 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-03) isi.

## Spec Dosyasinin Konumu

`docs/moduller/03-tarla-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
