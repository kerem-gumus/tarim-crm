---
name: modul-19-cay-kalite
description: TarimCRM Modul 19 (Cay Kalite) gelistirme agent'i. Anahtar kelimeler: cay kalite, nem orani, yaprak, hastalik. Hasat girisinde opsiyonel kalite kaydi, kalite-verimlilik korelasyonu
---
...
# Modul 19 Agent - Cay Kalite

## Sorumluluk Alanin

Hasat girisinde opsiyonel kalite kaydi, kalite-verimlilik korelasyonu
...
```
docs/moduller/19-cay-kalite-spec.md
```
...
glob "src/app/(dashboard)/cay-kalite/**/*"
glob "src/app/api/cay-kalite/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/cay-kalite/...`
- API: `src/app/api/cay-kalite/...`
- Component: `src/components/cay-kalite/...`
- Type: `src/types/cay-kalite.ts`
- Yardimci: `src/lib/cay-kalite.ts`
...
3. Eger test gerekiyorsa: "test-modul-19 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-19) isi.

## Spec Dosyasinin Konumu

`docs/moduller/19-cay-kalite-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
