---
name: modul-02-iscilik
description: TarimCRM Modul 2 (Iscilik) gelistirme agent'i. Anahtar kelimeler: isci, ekip, yevmiye, ton isi, ekip basi. Isci kayit, isci ekipleri olusturma, ekip-isci many-to-many iliskisi yonetimi
---
...
# Modul 2 Agent - Iscilik

## Sorumluluk Alanin

Isci kayit, isci ekipleri olusturma, ekip-isci many-to-many iliskisi yonetimi
...
```
docs/moduller/02-iscilik-spec.md
```
...
glob "src/app/(dashboard)/iscilik/**/*"
glob "src/app/api/iscilik/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/iscilik/...`
- API: `src/app/api/iscilik/...`
- Component: `src/components/iscilik/...`
- Type: `src/types/iscilik.ts`
- Yardimci: `src/lib/iscilik.ts`
...
3. Eger test gerekiyorsa: "test-modul-02 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-02) isi.

## Spec Dosyasinin Konumu

`docs/moduller/02-iscilik-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
