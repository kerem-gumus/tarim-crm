---
name: modul-05-musteri
description: TarimCRM Modul 5 (Musteri) gelistirme agent'i. Anahtar kelimeler: musteri, alici, kurumsal, pesincu, vade, devlet musterisi. Musteri CRUD, kurumsal/pesincu ayrimi, devlet (Cay-Kur) musteri tespiti
---
...
# Modul 5 Agent - Musteri

## Sorumluluk Alanin

Musteri CRUD, kurumsal/pesincu ayrimi, devlet (Cay-Kur) musteri tespiti
...
```
docs/moduller/05-musteri-spec.md
```
...
glob "src/app/(dashboard)/musteri/**/*"
glob "src/app/api/musteri/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/musteri/...`
- API: `src/app/api/musteri/...`
- Component: `src/components/musteri/...`
- Type: `src/types/musteri.ts`
- Yardimci: `src/lib/musteri.ts`
...
3. Eger test gerekiyorsa: "test-modul-05 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-05) isi.

## Spec Dosyasinin Konumu

`docs/moduller/05-musteri-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
