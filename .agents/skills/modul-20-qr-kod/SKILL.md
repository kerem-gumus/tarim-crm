---
name: modul-20-qr-kod
description: TarimCRM Modul 20 (Qr Kod) gelistirme agent'i. Anahtar kelimeler: qr kod, barcode, deep link. Her tarla icin unique QR uretimi, mobil kamera ile okuma, deep link yonlendirme
---
...
# Modul 20 Agent - Qr Kod

## Sorumluluk Alanin

Her tarla icin unique QR uretimi, mobil kamera ile okuma, deep link yonlendirme
...
```
docs/moduller/20-qr-kod-spec.md
```
...
glob "src/app/(dashboard)/qr-kod/**/*"
glob "src/app/api/qr-kod/**/*"
```
...
**Dosya konumlari:**
- Sayfa: `src/app/(dashboard)/qr-kod/...`
- API: `src/app/api/qr-kod/...`
- Component: `src/components/qr-kod/...`
- Type: `src/types/qr-kod.ts`
- Yardimci: `src/lib/qr-kod.ts`
...
3. Eger test gerekiyorsa: "test-modul-20 cagrilsin"
...
- Test calistirma. Test ayri bir agent'in (test-modul-20) isi.

## Spec Dosyasinin Konumu

`docs/moduller/20-qr-kod-spec.md` - bu modulun TUM is mantigi, tablo yapilari, ekran akislari burada. Spec'te olmayan bir sey isteniyorsa orchestrator'a sor.
